...
: ${IP2:="54.243.0.168"}
: ${IP3:="54.211.142.174"}
: ${IP4:="13.251.40.22"} #orgi4added
: ${IP5:="13.251.40.21"} #orgi4added
...
function generatePeerArtifacts() {
    ...
    if [ ${#} == 1 ]; then
      ...
      if [ ${org} == ${ORG1} ]; then
        ...
        api_extra_hosts=${DEFAULT_API_EXTRA_HOSTS6}
      elif [ ${org} == ${ORG7} ]; then
        api_extra_hosts=${DEFAULT_API_EXTRA_HOSTS7}
      elif [ ${org} == ${ORG8} ]; then
...
if [ "${MODE}" == "up" -a "${ORG}" == "" ]; then 
  ...
  joinWarmUp ${ORG6} common ${CHAINCODE_COMMON_NAME}
  ...
  generatePeerArtifacts ${ORG5} 4004 8085 2054 2051 2053 2056 2058
  generatePeerArtifacts ${ORG6} 4005 8086 3054 3051 3053 3056 3058
  ...
  generatePeerArtifacts ${ORGU2} 4019 8100 26054 26051 26053 26056 26058
